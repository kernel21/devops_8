...
3) Второй вариант: `ansible-playbook docker-provision_builtin.yml` копирует файлы проекта в удаленный каталог, собирает проект, запускает проект и проверяет его статус запуска. Структура docker-composer.yml описана непосредственно в файле плейбука ansible.
